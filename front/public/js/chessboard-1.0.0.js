...
(function () {
    ...
    var INIT_BALL_POSITION = 'e2';
    var BALL_SRC = 'public/img/ball.webp';
    ...
    function constructor(containerElOrString, config) {
        ...
        function buildPieceHTML(piece, hidden, id, hasBall = false) {
            var html = '<img src="' + buildPieceImgSrc(piece) + '" ';
            if (hasBall) {
                var html = '<img src="' + BALL_SRC + '" ';
            }
            if (isString(id) && id !== '') {
                html += 'id="' + id + '" ';
            }
        ...
        function drawPositionInstant() {
            ...
            for (var i in currentPosition) {
                ...
                $('#' + squareElsIds[i]).append(buildPieceHTML(currentPosition[i], false, squareElsIds[i], i == getBallPosition()));
            }
        }
        function drawBoard() {
